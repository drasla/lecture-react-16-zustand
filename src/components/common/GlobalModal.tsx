...
function GlobalModal() {
    ...
    return (
        ...
        */}
            <div
                className={twMerge(["absolute", "inset-0"], ["bg-black/10", "backdrop-blur-xs"])}
                onClick={closeModal}
            />
            ...
            */}
            <div
                ...
                <div
                    ...
                    <h3 className={twMerge(["text-lg", "font-bold"])}>{title}</h3>
                    <button
                        onClick={closeModal}
                        className={twMerge(["text-text-disabled", "hover:text-success-main"])}>
                        <FiX size={20} />
                    </button>
                </div>
